...
public:
    ...
    Sophus::SE3f TrackMonocular(const cv::Mat &im, const double &timestamp, const cv::Mat &mask = cv::Mat(), const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
